...
mod standard_transfer {
    ...
    const THIRTY_MINUTES_IN_MSEC: i64 = 30 * ONE_MINUTE_IN_MSEC;
    ...
    async fn boync_user_bid() {
        ...
        airdrop(&mut context, &player1.pubkey(), LAMPORTS_PER_SOL)
            .await
            .unwrap();
        ...
        */
        ...
        let expected_balance = LAMPORTS_PER_SOL - 150_000_000;
